                        ...
                        $.each(modelFilterState.includes, function (i, obj) {
                            if (obj.subseries === link) {
                                that.append(
                                    ...
                                    '<div class="img"><img src="' + obj.image + '" alt=""></div>' +
                                    '<div class="model">' +
                                    '<p class="series-title">' + obj.title + '</p>' +
                                    '</div>' +
                                    '<a href="' + obj.detailPath + '"  class="at-navigation" target="_blank" data-at-moudel="accessory-filter::redirect::' + lastNode(obj.detailPath) + '">' +
    ...
    $('.product-item.Bracket .offer-item').on('click', function (e) {
        ...
        for (var i = 0; i < ModelStateSelected.CameraMount.length; i++) {
            $('.pc-camera-mount , .mob-selector .cameramount .mount_wrap').append(
                ...
                '<a href="' + ModelStateSelected.CameraMount[i].detailPath + '" class="at-navigation" target="_blank"  data-at-mer="accessory-filter::redirect::'+lastNode(ModelStateSelected.CameraMount[i].detailPath)+'">' +
                '<img src="/etc/clientlibs/it/resources/icons/icon_yanjing.svg" alt="">' +
                '<span>Details</span>' +
                '</a>' +
                '</div>' +
                '<div class="img-con"> <img class="item" src="' + ModelStateSelected.CameraMount[i].image + '" alt=""></div>' +
